...
tidy_Tena <- select(Tena,Centro,Alimento,Ingreso,Peso_cosecha,Mortalidad,Mort_Tena)
head(tidy_Tena)
...
DT::datatable(tidy_Tena,caption="Tabla 1. Número de ingreso, peso cosecha y número de mortalidad por Centro")
