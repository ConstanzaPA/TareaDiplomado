...
interaction.plot(tidy_Tena$Centro,tidy_Tena$Alimento, tidy_Tena$Peso_g,trace.label="Alimento",fun=mean,main="Figura 9. Gráfico de interacción Peso promedio", xlab="Centro",ylab="Peso promedio (g)",type="b", col= c("black", "red"),pch=c(19,17))
...
interaction.plot(tidy_Tena$Centro,tidy_Tena$Alimento, tidy_Tena$Mortalidad,trace.label="Alimento",fun=mean,main="Figura 11. Gráfico de interacción Mortalidad total", xlab="Centro",ylab="Mortalidad",type="b", col= c("black", "red"),pch=c(19,17))
...
interaction.plot(tidy_Tena$Centro,tidy_Tena$Alimento, tidy_Tena$Mort_Tena,trace.label="Alimento",fun=mean,main="Figura 13. Gráfico de interacción Mortalidad Tenacibaculosis", xlab="Centro",ylab="Mortalidad Tenacibaculosis",type="b", col= c("black", "red"),pch=c(19,17))
