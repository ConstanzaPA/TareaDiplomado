...
#Establecer Centro como factor y visualizar que la variable está transformada en factor:
Tena$Centro <- as.factor(Tena$Centro)
summary(Tena)

#Ordenar Tena creando un objeto tidy_Tena:
...
#Establecer relación entre variables y el factor usando gráfico de interacción:
interaction.plot(tidy_Tena$Ingreso, tidy_Tena$Peso_g, tidy_Tena$Mortalidad, tidy_Tena$Mort_Tena, fun=mean, main="Gráfico de interacción", arg=NULL)
