...
3) Normalidad: en el histograma del porcentaje de mortalidad se observa que su distribución no es normal, ya que tiene distribución hacia la derecha. La normalidad también se determina con gráfico de cuartil-cuartil (Normal Q-Q) en un modelo lineal. 
