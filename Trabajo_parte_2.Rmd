...
1.1. Cargar la base de datos en el objeto Tena:
```{r Preparar datos 1, echo = TRUE, out.width = '70%', fig.align='center'}
...
1.2. Ordenar Tena creando un objeto tidy_Tena con las variables de interés:
...
1.3. Explorar si las variables son números o carácteres:
...
1.4. Transformar Unidad y Alimento a factor usando as.factor, luego visualizar que Unidad y Alimento estén transformados adecuadamente a factor y que los datos están balanceados:
...
En la tabla 1 se muestra la base de datos que se utiliza en este trabajo. Luego, en la tabla 2 está un resumen de estadística descriptiva.

2.1. Generar una tabla con la base de datos de tidy_Tena con función datatable:
...
2.2. Generar un resumen de estadística descriptiva con función pander:

```{r Tablas de datos y estadística 2, echo=TRUE}
