...
```{r Gráficos exploratorios, warning=FALSE, echo = TRUE, message=FALSE, out.width = '70%', fig.align='center'}
...
```{r blot, warning=FALSE, echo = TRUE, message=FALSE, out.width = '70%', fig.align='center'}
