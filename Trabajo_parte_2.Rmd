...
Histogramas: las tres variables no tienen distribución normal.
...
1) Boxplot de las variables por factor Unidad: 
...
2) Diagrama de caja y bigotes de las variables por factor Dieta: solo en el porcentaje de mortalidad según el tipo de dieta difieren las medianas y hay valores atípicos (puntos de color rojo).
