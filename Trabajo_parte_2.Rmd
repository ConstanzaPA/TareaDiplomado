...
mod_logit <- glm(Pro_Mort ~ Dieta, family=binomial, data = Salar)
...
- Se concluye que la hipotesis nula es rechazada, es decir, la dieta está asociada a la  mortalidad del Salmón del Atlántico.
