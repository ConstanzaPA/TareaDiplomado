...
```{r Boxplot variables por tipo de Dieta ,warning=FALSE, message=FALSE, out.width = '50%', fig.align='center'}
...
2) Gráfico de coeficiente de correlación de Spearman:

```{r Gráfico correlación ,warning=FALSE, message=FALSE, out.width = '50%', fig.align='center'}
