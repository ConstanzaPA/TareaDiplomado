...
#Cargar la base de datos en el objeto Dieta:
...
Tabla = Dieta %>% group_by(Dieta) %>%
summarize(N= n(), Mean = mean(Mortalidad),
          Variance= var(Mortalidad))

knitr::kable(Tabla,caption ="Estimadores puntuales de media y varianza de Mortalidad total para los tipos de Dieta")
```
